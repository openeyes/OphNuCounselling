...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('wrist_band_verified'))?>:</td>
			<td><span class="big"><?php echo $element->wrist_band_verified ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
