...
/**
 * This is the model class for table "et_ophnucounselling_patientid".
 *
 * The followings are the available columns in table:
 * @property string $id
 * @property integer $event_id
 * @property integer $wrist_band_verified
...
class Element_OphNuCounselling_PatientId  extends  BaseEventTypeElement
{
	...
	{
		return 'et_ophnucounselling_patientid';
	}
	...
	{
		return array(
			array('event_id, wrist_band_verified, dob, patient_name, parent_caregiver, chart_number, ', 'safe'),
			array('wrist_band_verified, dob, patient_name, parent_caregiver, chart_number, ', 'required'),
			array('id, event_id, wrist_band_verified, dob, patient_name, parent_caregiver, chart_number, ', 'safe', 'on' => 'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('wrist_band_verified', $this->wrist_band_verified);
