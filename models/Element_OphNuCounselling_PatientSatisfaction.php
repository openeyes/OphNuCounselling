...
/**
 * This is the model class for table "et_ophnucounselling_satisfaction".
 *
 * The followings are the available columns in table:
 * @property string $id
 * @property integer $event_id
 * @property integer $satisfaction_level
 * @property string $reason_for_satisfaction_level
 *
...
class Element_OphNuCounselling_PatientSatisfaction  extends  BaseEventTypeElement
{
	...
	{
		return 'et_ophnucounselling_satisfaction';
	}
	...
	public function search()
	{
		...
		$criteria->compare('satisfaction_level', $this->satisfaction_level);
		$criteria->compare('reason_for_satisfaction_level', $this->reason_for_satisfaction_level);
